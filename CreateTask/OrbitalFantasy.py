...
def game_loop():
    ...
    while switch2:
        ...
        for x in range(0, tlimit, 1):
            ...
            Velocity_P = font_20.render("Velocity=" + str(vp) + "AU/day", True, white, black)
            Acceleration_P = font_20.render("Acceleration=" + str(ap) + "AU/day^2", True, white, black)
            Force_P = font_20.render("Force=" + str(round(Fp, 2)) + "kg*AU/day^2", True, white, black)
            ...
            if Ep < 0:
                TotalEnergy_P = font_20.render("TotalEnergy=" + str(round(Ep, 2)) + "kg*AU^2/Day^2 PLANET IN BOUND!",
                                               True, white, black)
            else:
                TotalEnergy_P = font_20.render(
                    "TotalEnergy=" + str(round(Ep, 2)) + "kg*AU^2/Day^2 PLANET OUT OF BOUND!",
                    True, white, black)
            ...
            if Eq < 0:
                TotalEnergy_Q = font_20.render("TotalEnergy=" + str(round(Eq, 2)) + "kg*AU^2/Day^2 PLANET IN BOUND!",
                                               True, white, black)
            else:
                TotalEnergy_Q = font_20.render(
                    "TotalEnergy=" + str(round(Eq, 2)) + "kg*AU^2/Day^2 PLANET OUT OF BOUND!",
                    True, white, black)
